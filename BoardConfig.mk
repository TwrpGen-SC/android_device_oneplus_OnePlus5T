...
# Assert
TARGET_OTA_ASSERT_DEVICE := OnePlus5T

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 37201196 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_SOURCE := kernel/oneplus/OnePlus5T
TARGET_KERNEL_CONFIG := OnePlus5T_defconfig
